...
<div class="place">
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="/admin/ht/jobs/index">首页</a></li>
    <li><a href="#">数据表</a></li>
    <li><a href="#">基本内容</a></li>
    </ul>
    </div>
    ...
    <div class="tools">
        ...
        <a href="/admin/ht/jobs/add"><li class="click"><span><img src="/images/images/t01.png" /></span>添加</li></a>
        </ul>
    ...
    <form action="/admin/ht/jobs/dels" method="post"> 
    <table class="tablelist">
        ...
        <tr>
            ...
            <td>
                <a href="{:url('/admin/ht/jobs/edit',['id'=>$row.id])}?page={$page}" class="tablelist">编辑</a>&nbsp&nbsp
    ...
    $(document).ready(function(){
                ...
                success:function(msg){
                    if(msg.msg==1){
                        layer.confirm('删除成功', {icon:6,
                            ...
                            $(location).attr('href',"/admin/ht/jobs/index");
                       });
                    }
                }
            })
        ...
        btn2:function(index,layero){
            layer.close();
                    window.location.href="{:url('/admin/ht/jobs/index')}";
                }
            });
        });
