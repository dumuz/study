...
<div class="place">
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="/admin/ht/online/indext">首页</a></li>
    <li><a href="#">数据表</a></li>
    <li><a href="#">基本内容</a></li>
    </ul>
    </div>    
    ...
    <div class="tools">    
        <ul class="toolbar">
        <a href="/admin/ht/online/addt"><li class="click"><span><img src="/images/images/t01.png" /></span>添加</li></a>
        </ul>                
        <ul class="toolbar1">
        <li><span><img src="/images/images/t05.png" /></span>设置</li>
        </ul>    
    </div>
    <form action="/admin/ht/online/dels" method="post"> 
    <table class="tablelist">
        ...
        <tr>
            ...
            <td>{$row.intro}</td>
            <td>
                <a href="{:url('/admin/ht/online/editt',['id'=>$row.id])}" class="tablelink">查看详情</a>&nbsp&nbsp
    ...
    $(document).ready(function(){
                ...
                success:function(msg){
                    if(msg.msg==1){
                         layer.confirm('删除成功', {icon:6,
                                    ...
                                    $(location).attr('href',"/admin/ht/online/indext");
                           });
                    }
                }
            })
        ...
        btn2:function(index,layero){
            layer.close();
                    window.location.href="{:url('/admin/ht/online/indext')}";
                }
            });
        });
