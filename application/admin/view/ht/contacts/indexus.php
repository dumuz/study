...
<div class="place">
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="/admin/ht/contacts/indexus">首页</a></li>
    <li><a href="#">查询</a></li>
    <li><a href="#">基本内容</a></li>
    </ul>
    </div>
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
        <a href="/admin/ht/contacts/addus"><li class="click"><span><img src="/images/images/t01.png" /></span>添加</li></a>
        </ul>
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <td>{$row.ip}</td>
            <td>
                <a href="{:url('/admin/ht/contacts/edit',['id'=>$row.id])}?page={$page}" class="tablelink">编辑</a>&nbsp&nbsp
    ...
    $(document).ready(function(){
                ...
                success:function(msg){
                    if(msg.msg==1){
                         layer.confirm('删除成功', {icon:6,
                                    ...
                                    $(location).attr('href',"/admin/ht/contacts/indexus");
                           });
                    }
                }
            })
        ...
        btn2:function(index,layero){
            layer.close();
                    window.location.href="{:url('/admin/ht/contacts/indexus')}";
                }
            });
        });
