...
<div class="place">
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="/admin/ht/company/index">首页</a></li>
    <li><a href="#">数据表</a></li>
    <li><a href="#">基本内容</a></li>
    </ul>
    </div>
    ...
    <div class="tools">
        ...
        <a href="/admin/ht/company/add"><li class="click"><span><img src="/images/images/t01.png" /></span>添加</li></a>
        </ul>
    ...
    <form action="/admin/ht/company/dels" method="post"> 
    <table class="tablelist">
        ...
        <tr>
            ...
            <td>
                <a href="{:url('/admin/ht/company/edit',['id'=>$row.id])}?page={$page}" id="jbb">编辑</a>&nbsp&nbsp
                <a href="{:url('/admin/ht/company/dels',['id'=>$row.id])}" id="jbb">删除</a>
            </td>
        </tr>
        {/volist}
        </tr>
        ...
        $("#dels").on("click",function(){
            ...
            $.ajax({
                ...
                success:function(msg){
                    if(msg.msg==1){
                         layer.confirm('删除成功', {icon:6,
                            ...
                            $(location).attr('href',"/admin/ht/company/index");
                       });
                    }
                }
            })
                ...
                btn2:function(index,layero){
                    layer.close();
                    window.location.href="{:url('/admin/ht/company/index')}";
                }
            })
          })
    });
