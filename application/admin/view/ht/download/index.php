...
<div class="place">
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="/admin/ht/download/index">首页</a></li>
    <li><a href="#">数据表</a></li>
    <li><a href="#">基本内容</a></li>
    </ul>
    </div>
    ...
    <div class="tools">
        ...
        <ul class="toolbar"> 
        <a href="/admin/ht/download/add"><li class="click"><span><img src="/images/images/t01.png" /></span>添加</li></a>
        </ul>
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <td>
                <a href="{:url('/admin/ht/download/edit',['id'=>$row.id])}" id="jbb">编辑</a>&nbsp&nbsp
    ...
    $(document).ready(function(){
        ...
        $(".del").click(function(){
            ...
            layer.open({
                ...
                yes       : function(index,layero){
                    ...
                    var data = {id:id};
                    $.ajax({
                'url':"{:url('/admin/ht/download/dels')}",
                'type' :"POST",
                'data' :data,
                'dataType' : 'json',
                success:function(msg){
                    if(msg.msg==1){
                         layer.confirm('删除成功', {icon:6,
                                    ...
                                    $(location).attr('href',"/admin/ht/download/index");
                           });
                    }
                }
            })
        ...
        btn2:function(index,layero){
            layer.close();
                    window.location.href="{:url('/admin/ht/download/index')}";
                }
            });
        });
